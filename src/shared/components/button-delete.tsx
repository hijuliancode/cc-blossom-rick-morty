...
export const ButtonDelete = forwardRef<HTMLButtonElement, ButtonDeleteProps>(
  ({ className, iconClassName = "w-6 h-6", onClick, ...props }, ref) => {
    return (
      <button
        ref={ref}
        type="button"
        ...
        className={cn(
          "group flex items-center justify-center p-2 rounded-full transition-colors hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-200",
          className,
        )}
        {...props}
      >
